...
There are a bunch of reasons to use `read_csv` rather than `read.csv`
because of all kinds of things that happen in the background.

## How do I export data?

Instead of reading data in, we’re going to write data out.
